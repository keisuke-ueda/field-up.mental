  ...
  <div class="container">
    <div class="row mx-auto">
      <div class="col-md-7 page-title pt-5 pb-3 d-block mx-auto">
        <h1 class="text-center f1"><br class="br-sp"/>ココロとカラダ</h1>
      ...
      <div class="col-md-4 item mb-5">
        <div class="card p-3">
          <a href='{{ route("contents_sec.select", ["page_number"=>302])}}' class="w-100 h-100">
            ...
            <h3 class="">【好きなものを食べられないときのストレス(高血圧)】高血圧ってこうやってなるんだぁ...</h3>
          </a>
        </div>
      </div>
      ...
      <div class="col-md-4 item mb-5">
        <div class="card p-3">
          <a href='{{ route("contents_sec.select", ["page_number"=>303])}}' class="w-100 h-100">
            ...
            <h3 class="">【カラダを動かさないとココロも動かない(脳と神経)】脳ってすごいっ!!</h3>
          </a>
        </div>
      </div>
      ...
      <div class="col-md-4 item mb-5">
        <div class="card p-3">
          <a href='{{ route("contents_sec.select", ["page_number"=>304])}}' class="w-100 h-100">
            ...
            <h3 class="">【好きなものを食べられないときのストレス(ダイエット)】美味しいものをいっぱい食べたいっ!!</h3>
          </a>
        </div>
      </div>
      ...
      <div class="col-md-4 item mb-5">
        <div class="card p-3">
          <a href='{{ route("contents_sec.select", ["page_number"=>305])}}' class="w-100 h-100">
            ...
            <h3 class="">【カラダを動かさないとココロも動かなかい(迷走神経とリラックス)】ゆっくり休憩♪</h3>
          </a>
        </div>
      </div>
      ...
      <div class="col-md-4 item mb-5">
        <div class="card p-3">
          <a href='{{ route("contents_sec.select", ["page_number"=>306])}}' class="w-100 h-100">
            ...
            <h3 class="">【好きなものを食べられないときのストレス(高血糖)】甘いもの大好き!!</h3>
          </a>
        </div>
      </div>
