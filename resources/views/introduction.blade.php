  ...
  <div class="container parallax-bg {{$bg_img}}">
    <div class="scrollbox" style="height: auto; color: white;">
      <div class="row parallax-bg {{$bg_img}}">
        ...
        <div class="col-md-8" style="height: 325px; background-color: blanchedalmond;">
          <h3>問題提起</h3>
          画像を配置
        </div>
        <div class="col-md-4 parallax-bg {{$bg_img}}">
        </div>

        <div class="col-md-4 parallax-bg {{$bg_img}}">
        </div>
    
        <div class="col-md-8" style="height: 325px; background-color: aquamarine; position:relative; bottom: 50px;">
  ...
  <div class="container parallax-bg {{$bg_img}}">
    <div class="scrollbox" style="height: auto; color: white;">
      ...
      <div class="row">
        ...
        <div class="col-md-4 bg-info" style="height: 50px" >
          <h3>サービス紹介</h3>
        </div>
        <div class="col-md-4 parallax-bg {{$bg_img}}">
        </div>
