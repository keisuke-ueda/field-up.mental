...
@section('content')
  <div class="parallax-bg bg introduction">
    <p></p>
  </div>

  <div class="parallax-bg introduction">
    <div class="container parallax-bg introduction">
  ...
  <div class="parallax-bg introduction">
    <div class="container parallax-bg introduction">
      ...
      <div class="row">
        ...
        <div class="col-md-1 parallax-bg introduction">
        </div>
        <div class="col-md-7" style="height: 300px;">
          <h3>問題提起</h3>
          画像を配置
        </div>
        <div class="col-md-4 parallax-bg introduction">
        </div>
  ...
  <div class="parallax-bg introduction">
    <div class="container parallax-bg introduction">
      ...
      <div class="row">
        ...
        <div class="col-md-2 parallax-bg introduction">
        </div>
        <div class="col-md-4" style="height: 200px;">
          <h4>健康予防に関する情報の提供</h4>
      ...
      <div class="row">
        <div class="col-md-5 parallax-bg introduction">
        </div>
