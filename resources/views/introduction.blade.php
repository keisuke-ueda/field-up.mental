...
<div id="introduction">
  ...
  <div class=" container">
    <div class="row ">
      ...
      <div class="col-md-8 item" style="height: 325px;">
        <h3>問題提起</h3>
        画像を配置
      </div>
      <div class="col-md-4">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="order-md-1 col-md-5 item" style="height: 200px;">
      ...
      <div class="order-md-3 col-md-5 item" style="height: 200px;">
        <h4>健康予防に関する情報の提供</h4>
      ...
      <div class="order-md-7 col-md-5 item" style="height: 200px;">
      ...
      <div class="order-md-9 col-md-5 item" style="height: 200px;">
